...
import { Button, Overlay, Input, Icon, Card } from 'react-native-elements';
        ...
        <View>
            <Overlay isVisible={true} onBackdropPress={handleClose}>
                <View>
                    ...
                    <DropDownPicker
                        items={iconList}
                        defaultValue={newType.iconType?newType.iconType:iconList[0].value}
                    ...
                    <Input
                        placeholder="Couleur"
                        value={newType.colorType?newType.colorType:""}
